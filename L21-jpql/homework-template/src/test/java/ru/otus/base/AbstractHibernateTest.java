...
public abstract class AbstractHibernateTest {
    ...
    public void setUp() throws IOException {
        ...
        String dbUrl = props.getProperty("app.datasource.demo-db.jdbcUrl");
        String dbUserName = props.getProperty("app.datasource.demo-db.username");
        String dbPassword = props.getProperty("app.datasource.demo-db.password");

        var migrationsExecutor = new MigrationsExecutorFlyway(dbUrl, dbUserName, dbPassword);
        boolean cleanOnStart = Boolean.parseBoolean(props.getProperty("app.flyway.cleanOnStart", "true"));

        if (cleanOnStart) {
            migrationsExecutor.executeMigrationsWithCleanupDb();
        } else {
